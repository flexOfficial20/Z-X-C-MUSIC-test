...
API_ID = int(getenv("API_ID", "26533499"))
API_HASH = getenv("API_HASH", "f5cc95ded155458f379173419688493b")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO", "https://github.com/flexOfficial20/Z-X-C-MUSIC-test")
